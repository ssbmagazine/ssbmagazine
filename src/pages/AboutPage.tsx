    ...
    <article>
              ...
              return (
                <article className="person-card" key={person.id}>
                  ...
                  <div className="person-body">
                    ...
                    {detail ? <p className="person-detail">{detail}</p> : null}
                  </div>
                </article>
              );
            })}
      ...
      <section className="panel about-registration">
        ...
        <dl className="detail-list">
          ...
          <div>
            <dt>{t.about.regYear}</dt>
            <dd>{registration.year}</dd>
          </div>
          <div>
            <dt>{t.about.postalReg}</dt>
            <dd>
              <code>{registration.postal}</code>
            </dd>
          </div>
        </dl>
        <p className="cta-row">
